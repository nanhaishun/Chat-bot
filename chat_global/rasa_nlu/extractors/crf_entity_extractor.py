...
class CRFEntityExtractor(EntityExtractor):
    ...
    defaults = {
        ...
        "features": [
            ['pre3','pre2','pre1',"word", "word5", "word3", "word1", "pos", "pos2"],
            ["bias",'pre3','pre2','pre1', "word", "word5", "word3", "word1", "digit", "pos", "pos2", "pattern"],
            ['pre3','pre2','pre1',"word", "word5", "word3", "word1", "pos", "pos2"]],
    ...
    function_dict = {
        ...
        'word': lambda doc: doc[0],
        'pre3': lambda doc: doc[0][:3],
        'pre2': lambda doc: doc[0][:2],
        'pre1': lambda doc: doc[0][:1],
    ...
    def process(self, message, **kwargs):
        ...
        # print("entities: "+str(self.extract_entities(message)))
    @staticmethod
